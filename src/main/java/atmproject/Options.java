...
public class Options extends Account{
        ...
        do {
            ...
            switch (option){
                ...
                case 3:
                    ...
                    break;
                default:
                    System.out.println("Bu secenekten islem yapamiyoruz. Lutfen 1,2,3 veya 4 u kullaniniz");
            }
        }while (true);
        getAccountTypes();
    }
    ...
    public void getAccountTypes(){
        ...
        switch (option){
            ...
            case 3:
                ...
                break;
            default:
                System.out.println("Bu secenekten islem yapamiyoruz.Lutfen 1,2 veya 3'u kullaniniz");
        }
    }
    ...
    public void displayMessage(){
        ...
        System.out.println("1: View Balance"); //bakiye kontrolu
